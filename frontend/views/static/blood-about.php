...
$static=$data['static'];
?>
<section class="about blood-about-content">
    <div class="head">
        <div class="container">
            <div class="row page-arrange">
                <div class="col-xs-12 text-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Sizə təcili qan lazımdır?</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="about-content">
                    <div class="row">
                        <div class="col-md-8">
                            <h4 class="heading">Sizə təcili qan lazımdır?</h4>
                            <p class="premium-text">
                                Təcili qana ehtiyacınız varsa, e-tibb.az-ın “Qan ver” bölməsinə daxil olub, qeydiyyatdan keçməklə elan yerləşdirə bilərsiniz. Elanda qana ehtiyacı olan şəxsin adı, soyadı, yaşı və əlaqə nömrələri mütləq qeyd olunmalıdır.
                            </p>
