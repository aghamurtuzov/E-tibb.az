            ...
            <div class="row page-arrange">
                <div class="col-xs-12 text-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Donor olmaq istəyirsiniz?</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="about-content">
                    <div class="row">
                        <div class="col-md-8">
                            <h4 class="heading">Donor olmaq istəyirsiniz?</h4>
                            <p class="premium-text">
                                İnsan sağlamlığı və həyatının xilas olunması üçün qan köçürülməsinə zəruri ehtiyac olan hallar çoxdur. Təhlükəsiz qan ehtiyatının təmin edilməsinin əsas yolu könüllü, təmənnasız donorlardan qan götürülməsi hesab edilir. Xəsarətlər, kəskin qanaxmalar, əməliyyatlar, bir çox qan və onkoloji xəstəliklər zamanı qana ehtiyac olur.
                                Qan həyat xilas edir-Siz də donor olmaq, həyat xilas etmək istəyirsinizsə, saytımızın “Qan ver” bölməsinə daxil olub, qeydiyyatdan keçməklə elan yerləşdirin. Elanda donor olmaq istəyən şəxsin adı, soyadı, yaşı və əlaqə nömrələri mütləq qeyd olunmalıdır.
                            </p>
