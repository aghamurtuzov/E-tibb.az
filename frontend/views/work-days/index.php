                    ...
                    <div class="profile-tab">
                        <div class="row">
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <img class="img-fluid" src="assets/img/profile.png" alt="your image">
                            </div>
                            <div class="right-text col-md-8 col-sm-8 col-xs-12">
                                <a href="#" class="edit">Tənzimləmələr <i class="fa fa-pen"></i></a>
                                <ul class="doc-info">
                                    <li>Uzman Dr.</li>
                                    <li>Aynur Vəliyeva</li>
                                    <li>İxtisas</li>
                                    <li>İş təcrübəsi</li>
                                </ul>
                            </div>
                    ...
                    <nav>
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link " id="nav-home-tab" data-toggle="tab"
                               ...
                               aria-selected="true">Suallara cavab ver</a>
                            <a class="nav-item nav-link" id="nav-profile-tab"
                               href="<?= Url::base() . '/profile/aksiyalar'; ?>">Kampaniyalarını əlavə et</a>
                            <a class="nav-item nav-link active" id="nav-contact-tab" data-toggle="tab"
                               href="#nav-contact" role="tab" aria-controls="nav-contact"
                               aria-selected="false">Qəbul günlərini düzəlt</a>
                        </div>
                    </nav>
                </div>
            </div>
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane active" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                    <div class="t-card mini3 -h-top">
                        ...
                        <form action="/profile/qebul-gunleri" method="POST">
                            <div class="row">
