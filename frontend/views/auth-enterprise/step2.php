    ...
    <div class="row">
        <div class="col-12">
                    ...
                    <div class="col col-md-6 text-left text-md-right">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb" style="padding:15px 0 8px;">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Paketi seç</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="t-card mini3 -h-top nov radio-list">
                <h5>Paketlər</h5>
                <div class="bottom">
                    <p>Əgər Siz <a href="#">www.e-tibb.az</a> saytında klinikalar kataloqunda olmaq
                        istəyirsinizsə, aşağıdakı seçimlərdən yararlana bilərsiniz: </p>
                    <div class="row">
                        <?php
                        $all_price = 0;
                        if(!empty($packages)){
                                                        ...
                                                        <?php
                                                            if(!empty($service["prices"])) {
                                                                ...
                                                                foreach ($prices as $key => $price) {
                                                                    ?>
                                                                    <option value="<?= $service["id"] . "-" . $key . "-" . $price ?>"
                                                                            data-price="<?= $price ?>"><?= $key ?> aylıq
                                                                        - <?= $price ?>AZN
                                                                    </option>
                                                                    <?php
                                                                }
                ...
                <div class="bottom">
                    <div class="row">
                        <div class="col-12" id="service_month">
                            ...
                            1)Premium paket reklamvericinin bütün ay ərzində saytın əsas səhifəsində postunun
                            yerləşdirilməsi üçün nəzərdə tutulub.
                            <br><br>
                            2)Facebook, İnstagram qiymətləri ayda iki dəfə reklamverici barədə sponsorlu postun yerləşdirilməsi üçün nəzərdə tutulub.
                            <br>

                            <!--                            <strong>Premium paket</strong>-->
                            <br>
                            3)Videorolik sifarişçinin istəyindən asılı olaraq hazırlanır, montaj olunur, youtubedeki e-tibb kanalına yerləşdirilir və istəyə uyğun olaraq müştəriyə təhvil verilir.
                            <br>
