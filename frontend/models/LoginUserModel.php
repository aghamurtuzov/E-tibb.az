 ...
 */
class LoginUserModel extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        $rules = [
            ...
            ['email', 'unique', 'targetClass' => '\frontend\models\LoginUserModel', 'message' => 'Bu email ilə istifadəçi artıq qeydiyyatdan keçmişdir.'],
            ...
            [['phone_number'], 'safe', 'min' => 10, 'max' => 40],
            ['birthday', 'safe'],
