...

{
    ...
    public function validate($file,$allowMimeTypes = ["image/gif", "image/png", "image/jpeg", "image/pjpeg", "image/jpg"])
    {
...

    {
        ...
        $allowMimeTypes = isset($options['allow.MimeTypes']) ? $options['allow.MimeTypes'] : ["image/gif", "image/png", "image/jpeg", "image/pjpeg", "image/jpg"];
...

        {
...

            {
...

                {
                    ...
                    $loadedFile->resize($options['resize.img'][0],$options['resize.img'][1],$master)->save($fullPath.$photo,75);
...

                {
                    ...
                    $loadedFile->resize($options['resize.thumb'][0],$options['resize.thumb'][1],$master)->save($fullThumbPath.$photo,75);
...

    {
...

        {
...

            {
                ...
                $loadedFile->resize($options['resize.img'][0],$options['resize.img'][1],$master)->save($fullPath.$clone_name,75);
...

            {
                ...
                $loadedFile->resize($options['resize.thumb'][0],$options['resize.thumb'][1],$master)->save($fullThumbPath.$clone_name,75);
