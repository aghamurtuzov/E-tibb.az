                            ...
                            <div class="col-md-6">
                                <div class="general-info">
                                    <div class="validate-block">
                                        <div class="input-group input-up">
                                            <label>
                                                <input type="text" placeholder=" " class="form-control inputText" v-model="newEnterprises.contact_phone">
                            ...
                            <div class="col-md-6">
                                <div class="general-info">
                                    <div class="validate-block">
                                        <div class="input-group input-up">
                                            <div class="textup">
                                                <datepicker  placeholder="Əlaqələndirici şəxsin doğum günü*" v-model="newEnterprises.contact_birthday"></datepicker>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="block">
                                ...
                                <div v-for="(item, index) in phone_numbers">
                                    <div class="general-info addListContainer phoneList">
                                        <div class="input-group input-up">
                                            <label>
                                                <input type="text" placeholder=" " class="form-control inputText" v-model="phone_numbers[index].number">
                        ...
                        <div class="col-md-6">
                            <div class="block">
                                ...
                                <div v-for="(item, index) in mobile_numbers">
                                    <div class="general-info addListContainer mobileList">
                                        <div class="input-group input-up">
                                            <label>
                                                <input type="text" placeholder=" " class="form-control inputText" v-model="mobile_numbers[index].number">
                ...
                <div class="addition-address">
                    <div class="block">
                        ...
                        <div v-for="(item, index) in newEnterprises.addresses">
                            <div class="general-info addListContainer workList">
                                <div class="input-group input-up">
                                    <label>
                        ...
                        <div class="certificate">
                            ...
                            <div class="certificate-list">
                                <div class="certificate-images">
                                    <img class="preview" v-for="(file, key) in newEnterprises.ct_files" v-bind:ref="'img'+parseInt( key )" alt="certificate">
                                </div>
                                <div class="file-upload-wrapper" data-text="">
                                    <label class="custom-file-upload">
                        ...
                        <div class="general-info">
                            <ul  class="list-unstyled">
                                ...
                                <li>
                                    <div class="input-group input-up">
                                        <label>
                                            <input type="text" placeholder=" " v-model="phones[0].number" class="form-control inputText" >
