                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="upload-hour">
                                            <div class="input-group input-up">
                                                <div class="textup">
                                                    <input type="text" v-model="BlogData.time"
                    ...
                    <div class="block">
                        ...
                        <div class="validate-block">
                            <div class="upload-article">
                                <p>Məqalə</p>
                                <tinymce-editor v-model="BlogData.content" :init="tinymce_config"></tinymce-editor>
            ...
            getNewsData: function () {
                axios.get('/news/info/?id='+this.$route.params.id).then(
                    response => {
                        ...
                        this.BlogData.status=this.newBlog.status == '1';
                        this.BlogData.content=this.newBlog.content ;
                        let date = new Date(this.newBlog.datetime);
                        this.BlogData.date=date;
                        this.BlogData.time= ("0" + date.getHours()).slice(-2) + ":" + ("0" + date.getMinutes()).slice(-2);
                    }
                )
            },
            handleFileUpload() {
