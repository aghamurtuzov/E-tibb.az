                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-7 col-sm-7">
                                <div class="general-info">
                                    ...
                                    <div class="input-group input-up">
                                        <label>
                                            <input type="text" placeholder=" " class="form-control inputText" v-model="PostEnterprises.company_email[0]">
                            ...
                            <div class="block">
                                ...
                                <div v-for="(item, index) in PostEnterprises.phone_numbers.a0">
                                    <div class="general-info addListContainer phoneList flex-end">
                                        <div class="input-group input-up">
                                            <label>
                                                <input type="number" placeholder=" " class="form-control inputText" v-model="PostEnterprises.phone_numbers.a0[index]" minlength="12" maxlength="12">
                            ...
                            <div class="block">
                                ...
                                <div v-for="(item, index) in PostEnterprises.phone_numbers.a1">
                                    <div class="general-info addListContainer mobileList flex-end">
                                        <div class="input-group input-up">
                                            <label>
                                                <input type="number" placeholder=" " class="form-control inputText" v-model="PostEnterprises.phone_numbers.a1[index]" maxlength="12" minlength="12">
                ...
                <div class="addition-address">
                    <div class="block">
                        ...
                        <div v-for="(item, index) in PostEnterprises.addresses">
                            <div class="general-info addListContainer workList flex-end">
                                <div class="input-group input-up">
                                    <label>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-6">
                                <div class="general-info">
                                    <div class="validate-block">
                                        <div class="input-group input-up">
                                            <label>
                                                <input type="text" placeholder=" " class="form-control inputText" v-model="PostEnterprises.email" :disabled="!!PostEnterprises.email">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-6">
                                <div class="general-info">
                                    <div class="validate-block">
                                        <div class="input-group input-up">
                                            <label>
                                                <input type="number" placeholder=" " class="form-control inputText" v-model="PostEnterprises.contact_phone" minlength="12" maxlength="12">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-6">
                                <div class="general-info">
                                    <div class="validate-block">
                                        <div class="input-group input-up">
                                            <div class="textup">
                                                <datepicker  placeholder="Əlaqələndirici şəxsin doğum günü*" v-model="PostEnterprises.contact_birthday" :language="az"></datepicker>
                                            </div>
                                        </div>
                        ...
                        <div class="general-info">
                            <ul  class="list-unstyled">
                                ...
                                <li>
                                    <div class="input-group input-up">
                                        <label>
                                            <input type="number" placeholder=" " v-model="PostEnterprises.phone_numbers.a2[0]" class="form-control inputText" maxlength="12" minlength="12">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submitFile() {
                this.resetErrors();
                let enterprisecategory_id = this.enterprisecategory_id;
                ...
                axios.post('/enterprises/edit', formdata, enterprisecategory_id).then (
                    res =>{
                        ...
                        if(res.data.status==200){
                            ...
                            window.setTimeout(function(){
                              window.location.href = '/admin/general?#/enterprises?id='+ enterprisecategory_id;
                            } ,2000);
                        }
                    }).catch(error => {
            ...
            getEnterpriseData:function () {
                axios.get('/enterprises/info/'+this.id).then(
                    response=> {
                        ...
                        this.enterprisecategory_id = this.EnterprisesData.enterprise.category_id;
                        ...
                        for(let i in this.sosial_links){
                                this.PostEnterprises.sosial_links[i] = {
                                    id: 0,
                                    link : " ",
                                    link_type : i.toString()
                                }
                        }
                        for (let i of this.EnterprisesData.social_links) {
                            this.PostEnterprises.sosial_links[i.link_type]=i
                        }
                        ...
                        this.PostEnterprises.contact_phone=this.EnterprisesData.enterprise.contact_phone;
