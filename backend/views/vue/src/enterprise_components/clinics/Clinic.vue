                        ...
                        <div class="clinic-information">
                            <div class="block">
                                <div class="logo-login">
                                    <img :src="ClinicData.enterprise.thumb" alt="clinic-inner-logo" class="img-responsive">
                                    <p>Qeydiyyat nömrəsi
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="clinic-notify">
                                    <div class="block">
                                        ...
                                        <div class="input-group">
                                            <textarea name="notify" id="notify" cols="30" rows="9" placeholder="Bildiriş mətni"  class="form-control"></textarea>
                                        </div>
