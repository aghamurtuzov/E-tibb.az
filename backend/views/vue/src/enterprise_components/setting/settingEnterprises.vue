<template>
    <div class="setting-clinic clinic-new new-addition blog">
        ...
        <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="block">
                                ...
                                <div v-for="(item, index) in PostEnterprises.phone_numbers.a0">
                                    <div class="general-info phoneList addListContainer flex-end">
                                        <div class="input-group input-up">
                                            <label>
                                                <input type="number" placeholder=" " class="form-control inputText" v-model="PostEnterprises.phone_numbers.a0[index]">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="block">
                                ...
                                <div v-for="(item, index) in PostEnterprises.phone_numbers.a1">
                                    <div class="general-info mobileList addListContainer flex-end">
                                        <div class="input-group input-up">
                                            <label>
            ...
            <div class="col-md-5">
                <div class="bio-diplom ptx-30">
                    <div class="block">
                       <div class="validate-block">
                           <div class="biography">
                               <p class="info">Obyekt haqqında*</p>
                               <div class="input-group">
                                   <tinymce-editor v-model="PostEnterprises.about" :init="tinymce_config"></tinymce-editor>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-6">
                                <div class="general-info">
                                    <div class="validate-block">
                                        <div class="input-group input-up">
                                            <label>
                                                <input type="number" placeholder=" " class="form-control inputText" v-model="PostEnterprises.contact_phone">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-6">
                                <div class="general-info">
                                    <div class="validate-block">
                                        <div class="input-group input-up">
                                            <div class="textup">
                                                <datepicker  placeholder="Əlaqələndirici şəxsin doğum günü*" v-model="PostEnterprises.contact_birthday" :language="ru"></datepicker>
                                            </div>
                                        </div>
                        ...
                        <div class="general-info">
                            <ul  class="list-unstyled">
                                ...
                                <li>
                                    <div class="input-group input-up">
                                        <label>
                                            <input type="number" placeholder=" " v-model="PostEnterprises.phone_numbers.a2[0]" class="form-control inputText" >
            ...
            getEnterpriseData:function () {
                axios.get('/enterprises/info').then(
                    response=> {
                        ...
                        this.PostEnterprises.phone_numbers = {
                            a0: [],
                            a1: [],
                            a2: []
                        };
