<template>
    <div class="setting-doctor new-addition blog">
        <breadcrumb name="Tənzİmləmələr" icon="fa-cog" :routes="[{url:'/profile/cpp#/setting/' + id,name:'Həkimlər'},{name:'Tənzimləmələr'}]"></breadcrumb>
        <div class="row">
            <div class="col-md-7">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="general-info">
                                        <div class="input-group input-up">
                                            <label>
                                                <input type="number" placeholder=" " class="form-control inputText"  v-model="Post_data.phone_numbers[0].number">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="general-info">
                                        <div class="input-group input-up">
                                            <label>
                                                <input type="number" placeholder=" " class="form-control inputText"  v-model="Post_data.phone_numbers[1].number">
                        ...
                        <div class="general-info">
                            <ul  class="list-unstyled">
                                ...
                                <li>
                                    <div class="input-group input-up">
                                        <label>
                                            <input type="number" placeholder=" "  v-model="Post_data.phone_numbers[2].number" class="form-control inputText" >
            ...
            getDoctorData:function () {
                axios.get('/doctors/info/'+this.id,this.Doctor_data).then(
                    response=> {
                        ...
                        for(let i in [0,1,2]) {
                            this.Post_data.phone_numbers[i]= typeof this.Doctor_data.phones[i] != 'undefined' ? this.Doctor_data.phones[i] : {type: i, number: ''}
                        }
