...
class SiteNews extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['headline', 'datetime', 'content', 'category_id', 'content', 'keywords'], 'required'],
            ['datetime', 'datetime', 'format' => 'php:Y-m-d H:i'],
            [['category_id', 'news_read'], 'integer'],
            [['status'], 'integer'],
            [['content'], 'string'],
            [['photo', 'mainImage', 'deletedImages'], 'string'],
            [['datetime'], 'safe'],
            [['headline','keywords', 'slug'], 'string', 'min' => 3],
            ['content', 'string', 'min' => 10],
            [['headline','keywords', 'slug', 'content'], 'string', 'max' => 250],
            [['files', 'images'], 'file','skipOnEmpty' => true, 'extensions'=>'png,jpg,jpeg','maxFiles' => 30,'wrongExtension'=>'Yalnız {extensions}']
        ];
    }
