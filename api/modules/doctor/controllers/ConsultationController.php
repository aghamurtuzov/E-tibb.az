...
use api\modules\doctor\models\ConsultationApiModel;
...
class ConsultationController extends MainController
{
    ...
    /**
     * Suallar
     * https://e-tibb.az/api/doctor/consultation
     * https://e-tibb.az/api/doctor/consultation?page=1&count=5
     */
    ...
    /**
     * Sual
     * https://e-tibb.az/api/doctor/consultation/info/123
     */
    ...
    /**
     * Sual block
     * https://e-tibb.az/api/doctor/consultation/block
     */
    ...
    /**
     * Cavab ver
     * https://e-tibb.az/api/doctor/consultation/answer
     */
    public function actionAnswer()
    {
        ...
        if(!empty($answer))
        {
            ...
            if($update)
            {
                $data = ConsultationApiModel::consultationFind($id);
    ...
    /**
     * Cavab block
     * https://e-tibb.az/api/doctor/consultation/block-answer
     */
    ...
    /**
     * Sual aktiv
     * https://e-tibb.az/api/doctor/consultation/active
     */
    ...
    /**
     * Cavab aktiv
     * https://e-tibb.az/api/doctor/consultation/active-answer
     */
    ...
    /**
     * Sual sil
     * https://e-tibb.az/api/doctor/consultation/del
     */
    ...
    /**
     * Cavab delete
     * https://e-tibb.az/api/doctor/consultation/delete-answer
     */
    public function actionDeleteAnswer()
    {
        ...
        $update = ConsultationApiModel::DeleteAnswer($id, ConsultationApiModel::STATUS_DEACTIVE,$doctor_id);
        if ($update) {
            $data = ConsultationApiModel::consultationFind($id);
            AdminDoctorLog::write(['id' => $id, 'name' => $data['name']]);
            return $this->response(200, "Melumat silindi");
    ...
    /**
     * Cavab sil
     * https://e-tibb.az/api/doctor/consultation/del-answer
     */
