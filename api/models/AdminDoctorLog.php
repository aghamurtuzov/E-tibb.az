 ...
 */
class AdminDoctorLog extends Model
{
    /**
     * {@inheritdoc}
     */
    ...
    public static function write($data = [],$action = '')
    {
        ...
        return Yii::$app->db->createCommand("INSERT INTO `admin_doctor_log` (`info`,`action`,`module`,`created_at`, `user_id`,`ip`) VALUES ('" . $info . "','" . $action . "','" . $module . "', '" . $date . "', '" . $userId . "','".$ip."')")->execute();
